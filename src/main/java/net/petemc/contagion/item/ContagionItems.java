...
public class ContagionItems {
    public static final Item CONTAGIOUS_FLESH = registerItem("contagious_flesh", new Item(new FabricItemSettings().food(ContagionFoodComponents.CONTAGIOUS_FLESH)));
    public static final Item HEAT_TREATED_FLESH = registerItem("heat_treated_flesh", new Item(new FabricItemSettings().food(ContagionFoodComponents.HEAT_TREATED_FLESH)));
    public static final Item GOLD_STREAKED_FLESH = registerItem("gold_streaked_flesh", new Item(new FabricItemSettings().food(ContagionFoodComponents.GOLD_STREAKED_FLESH)));
