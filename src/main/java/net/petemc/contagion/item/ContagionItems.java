...
public class ContagionItems {
    ...
    public static final DeferredItem<Item> CONTAGIOUS_FLESH = ITEMS.register("contagious_flesh",
            () -> new Item(new Item.Properties()
                    .setId(ResourceKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath(Contagion.MOD_ID, "contagious_flesh")))
    ...
    public static final DeferredItem<Item> HEAT_TREATED_FLESH = ITEMS.register("heat_treated_flesh",
            () -> new Item(new Item.Properties()
                    .setId(ResourceKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath(Contagion.MOD_ID, "heat_treated_flesh")))
    ...
    public static final DeferredItem<Item> GOLD_STREAKED_FLESH = ITEMS.register("gold_streaked_flesh",
            () -> new Item(new Item.Properties()
                    .setId(ResourceKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath(Contagion.MOD_ID, "gold_streaked_flesh")))
