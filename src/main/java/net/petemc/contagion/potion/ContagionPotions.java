...
public class ContagionPotions {
    ...
    public static final Holder<Potion> CURE_POTION = POTIONS.register("cure_potion",
            () -> new Potion(new MobEffectInstance(ContagionEffects.IMMUNITY, MainConfig.getImmunityDuration() * 20, 0)));
    public static final Holder<Potion> LONG_CURE_POTION = POTIONS.register("long_cure_potion",
            () -> new Potion(new MobEffectInstance(ContagionEffects.IMMUNITY, MainConfig.getImmunityDuration() * 20 * 3, 0)));
