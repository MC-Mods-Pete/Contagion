...
public class ContagionPotions {
    public static final Potion CURE_POTION = registerPotion("cure_potion",
            new Potion(new StatusEffectInstance(ContagionEffects.IMMUNITY, MainConfig.getImmunityDuration() * 20, 0)));
    public static final Potion LONG_CURE_POTION = registerPotion("long_cure_potion",
            new Potion(new StatusEffectInstance(ContagionEffects.IMMUNITY, MainConfig.getImmunityDuration() * 3 * 20, 0)));
