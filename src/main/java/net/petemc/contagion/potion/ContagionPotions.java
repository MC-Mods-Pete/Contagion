...
public class ContagionPotions {
    ...
    public static final Holder<Potion> CURE_POTION = POTIONS.register("cure_potion",
            () -> new Potion("cure_potion", new MobEffectInstance(ContagionEffects.IMMUNITY, Config.immunityDuration * 20, 0)));
    public static final Holder<Potion> LONG_CURE_POTION = POTIONS.register("long_cure_potion",
            () -> new Potion("long_cure_potion", new MobEffectInstance(ContagionEffects.IMMUNITY, Config.infectionDuration * 20 * 3, 0)));
