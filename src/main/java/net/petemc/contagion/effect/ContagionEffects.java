...
public class ContagionEffects {
    ...
    public static RegistryEntry<StatusEffect> INFECTIOUS;
    ...
    public static void registerEffects() {
        ...
        INFECTIOUS = registerContagionEffect("infectious", new ContagionInfectiousEffect(StatusEffectCategory.HARMFUL, 0xAA0000));
    }
