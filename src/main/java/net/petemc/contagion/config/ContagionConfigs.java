...
public class ContagionConfigs {
    ...
    public static int DURATION_IMMUNITY;
    ...
    private static void createConfigs() {
        configs.addKeyValuePair(new Pair<>("infection.duration.total", 600), "seconds");
        configs.addKeyValuePair(new Pair<>("infection.duration.symptoms", 30), "seconds");
        ...
        configs.addKeyValuePair(new Pair<>("immunity.duration", 120), "seconds");
    }

    private static void assignConfigs() {
        DURATION_INFECTION_TOTAL = CONFIG.getOrDefault("infection.duration.total", 600);
        DURATION_INFECTION_SYMPTOMS = CONFIG.getOrDefault("infection.duration.symptoms", 30);
        ...
        DURATION_IMMUNITY = CONFIG.getOrDefault("immunity.duration", 120);
