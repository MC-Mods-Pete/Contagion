    ...
    public static final IGuiOverlay HUD_PROTECTION = ((gui, poseStack, partialTick, width, height) -> {
        ...
        if ((Config.displayCurrentInfectionProtection) && (receivedBaseInfectionChance != -1)) {
            ...
            if (mc.gameMode.hasExperience() || mc.gameMode.hasInfiniteItems()) {
                ...
                GuiComponent.blit(poseStack, (width / 2) - 170 + Config.deltaX, height - 19 + Config.deltaY, 0, 0, 16, 16, 16, 16);
                GuiComponent.drawString(poseStack, mc.font, infectionProtection + "%", (width / 2) + 18 - 170 + Config.deltaX, height - 14 + Config.deltaY, color);
            }
        }
    });
}
